    ...
    _createClass(Chart, [{
        ...
        value: function drawChart() {
            ...
            d3.csv("multiLine.csv").then(function (data) {
                ...
                // Add Chart Title
                svg.append("text").attr("x", 25 - margin.left).attr("y", 20 - margin.top).attr("fill", "#333").attr('font-size', '18').style("text-anchor", "beginning").text("Multiline radial of all locations");
                ...
                var lg = legend.selectAll('g').data(measurements).enter().append('g').attr('transform', function (d, i) {
                    return "translate(" + i * 100 + "," + -margin.top / 2 + ")";
                });
                ...
                function updatePropVal() {
                    ...
                    focus.select('#focusLineX').attr('x1', x).attr('y1', yScale(0.00)).attr('x2', x).attr('y2', yScale(1.00));
