...
function (_React$Component) {
  ...
  function TimeRangeSelect(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(TimeRangeSelect).call(this, props));
    _this.state = {
  ...
  _createClass(TimeRangeSelect, [{
    ...
    value: function render() {
      ...
      return React.createElement(Row, {
        ...
        className: (this.state.selected ? 'selected' : '') + " time-range flex-nowrap align-items-center py-2"
